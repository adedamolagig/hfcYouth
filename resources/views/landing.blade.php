...
<html>
	...
	<title>Church &mdash; Free Website Template, Free HTML5 Template by </title>
			...
			<div class="top-menu">
				<div class="row">
					<div class="col-md-12 col-offset-0 text-center">
						<div id="fh5co-logo"><a href="index.html">HFC Youth</a></div>
					</div>
	...
	<div class="container-wrap">
				   				...
				   				<div class="slider-text">
					   				<div class="slider-text-inner">
					   					<h1>Living &amp; Sharing the Gospel of God</h1>
											<h2>Design by OgundeindeA <a href="#" target="_blank"></a></h2>
				   				...
				   				<div class="slider-text">
					   				<div class="slider-text-inner">
					   					<h1>Tell The World</h1>
											<h2>Holy Flock of Christ Youth <a href="#" target="_blank"></a></h2>
											<p><a class="btn btn-primary btn-demo popup-vimeo" href="https://vimeo.com/channels/staffpicks/93951774"> <i class="icon-play4"></i> Watch Video</a> <a class="btn btn-primary btn-learn">Join us here! <i class="icon-arrow-right3"></i></a></p>
					   				</div>
					   			</div>
				   			</div>
				   				...
				   				<div class="slider-text">
					   				<div class="slider-text-inner text-center">
					   					<h1>Know More About Jesus</h1>
											<h2>Design by Keys2Imagination <a href="#" target="_blank"></a></h2>
											<p><a class="btn btn-primary btn-demo popup-vimeo" href="https://vimeo.com/channels/staffpicks/93951774"> <i class="icon-play4"></i> Watch Video</a> <a class="btn btn-primary btn-learn">Join us here! <i class="icon-arrow-right3"></i></a></p>
					   				</div>
					   			</div>
				   			</div>
		...
		<div id="fh5co-services" class="fh5co-light-grey">
			...
			<div class="row">
				<div class="col-md-4 animate-box">
					<div class="services">
						<a href="#" class="img-holder"><img class="img-responsive" src="images/img-1.jpg" alt="designed by OgundeindeAdedamola "></a>
						<div class="desc">
				...
				<div class="col-md-4 animate-box">
					<div class="services">
						<a href="#" class="img-holder"><img class="img-responsive" src="images/img-3.jpg" alt="designed by OgundeindeAdedamola "></a>
						<div class="desc">
				...
				<div class="col-md-4 animate-box">
					<div class="services">
						<a href="#" class="img-holder"><img class="img-responsive" src="images/img-2.jpg" alt="designed by OgundeindeAdedamola "></a>
						<div class="desc">
		...
		<div id="fh5co-news" class="fh5co-light-grey">
			...
			<div class="row">
				...
				<div class="col-md-3 animate-box">
					<div class="news">
						<a href="#" class="img-holder"><img class="img-responsive" src="images/img-4.jpg" alt="designed by OgundeindeAdedamola "></a>
						<div class="desc">
							<span class="date">March 30, 2017</span>
							<h3><a href="#">Helping Children</a></h3>
							<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
	...
	<div class="container-wrap">
		<footer id="fh5co-footer" role="contentinfo">
			<div class="col-md-4 text-center">
				<h3>45, Okepopo Street, Lagos, Nigeria, West Africa</h3>
			</div>
			<div class="col-md-4 text-center">
			...
			<div class="row copyright">
				<div class="col-md-12 text-center">
					<p>
						<small class="block">&copy; 2018 OGDevelopers.</small> 
						<small class="block">Designed by <a href="#" target="_blank"></a>  <a href="#" target="_blank">Ogundeinde Adedamola</a></small>
					</p>
				</div>
			</div>
		</footer>
